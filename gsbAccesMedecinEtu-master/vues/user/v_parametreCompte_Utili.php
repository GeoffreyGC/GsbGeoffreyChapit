			...
			<div class="login-wrapper">
				<div class="box">
						...
						<legend>Parametre : </legend>
                                                        ...
                                                        <a class="btn btn-primary" href="index.php?uc=droit&action=demandeModification">Modifier les informations du compte</a>
							<br/><br/><br/>
                                                        <a class="btn btn-primary" href="index.php?uc=droit&action=supprimerCompte">Supprimer mon compte</a>
                                                        <br/><br/><br/>
                                                        <a class="btn btn-primary" href="index.php?uc=droit&action=recupererDonneePersonnelle">Récupérer mes données personnelles</a>
