			...
			<div class="login-wrapper">
				<div class="box">
						...
						<legend>Supprimer mon compte</legend>
                                                        ...
                                                        <a class="btn btn-primary" href="index.php?uc=droit&action=supprimer">Supprimer definitivement mon compte</a>
                                                        <p class="text-center"> ou</p>
                                                        <a class="btn btn-primary" href="index.php?uc=droit&action=archiver">Archiver mon compte</a>
