		...
		<div class="col-md-4 col-md-offset-4">
			<div class="login-wrapper">
				<div class="box">
						...
						<legend>Êtes vous sûr de vouloir archiver votre compte</legend>
							
                                                        <a class="btn btn-primary" href="index.php?uc=droit&action=archiverOK">OUI</a><br/><br/>
                                                        
                                                        <a class="btn btn-primary" href="index.php?uc=droit&action=supprimerCompte">NON</a>
